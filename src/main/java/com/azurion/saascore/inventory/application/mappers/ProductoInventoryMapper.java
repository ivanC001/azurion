...
public final class ProductoInventoryMapper {
    ...
    public static ProductoResponse toResponse(Producto producto, BigDecimal stockCantidad) {
        return new ProductoResponse(
                ...
                producto.getPrecio(),
                producto.getAlmacen() == null ? null : producto.getAlmacen().getId(),
                producto.getAlmacen() == null ? null : producto.getAlmacen().getCodigo(),
                producto.getAlmacen() == null ? null : producto.getAlmacen().getNombre(),
