...
public record CreateEmpresaRegistrationRequest(
        ...
        @NotBlank @Pattern(regexp = "^[a-z][a-z0-9_]{2,62}$") String tenantId,
        @NotBlank @Pattern(regexp = "^[a-z][a-z0-9_]{2,62}$") String schemaName,
        @NotNull Long planId,
