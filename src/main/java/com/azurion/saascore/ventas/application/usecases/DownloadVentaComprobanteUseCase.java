...
public class DownloadVentaComprobanteUseCase {
    ...
    public FacturadorClient.FacturadorArtifactDownload execute(Long ventaId) {
        ...
        if (Venta.FACTURACION_ESTADO_NO_REQUIERE.equalsIgnoreCase(venta.getFacturacionEstado())) {
            throw BusinessException.conflict(
                    ...
                    "La venta es un ticket interno y no tiene comprobante electronico"
            );
        }
        ...
        return facturadorClient.descargarPdfComprobante(tenantId, empresa.getRuc(), venta.getExternalId());
    }
}
